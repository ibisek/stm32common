...
/**
 *
 * STM32L152: I2C1 mapped to PB6 (SCL) and PB7 (SDA)	(PRIMARY)
 * STM32L152: I2C1 mapped to PB(SCL) and PB9 (SDA)		(SECONDARY) (I2C on NUCLEO board)
 *
 * STM32L152: I2C2 mapped to PB10 (SCL) and PB11 (SDA)
 *
 * @param ownAddress
...
//		GPIO_PinAFConfig(GPIOB, GPIO_PinSource6, GPIO_AF_I2C1);// alternate function I2C1_SCL
//		GPIO_PinAFConfig(GPIOB, GPIO_PinSource7, GPIO_AF_I2C1);// alternate function I2C1_SDA
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource8, GPIO_AF_I2C1);// alternate function I2C1_SCL
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource9, GPIO_AF_I2C1);// alternate function I2C1_SDA
		...
		// Alternate function mapping:
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource10, GPIO_AF_I2C2);// alternate function I2C1_SCL
		GPIO_PinAFConfig(GPIOB, GPIO_PinSource11, GPIO_AF_I2C2);// alternate function I2C1_SDA
